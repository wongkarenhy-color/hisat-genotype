...
#                                                                             #
# This file is part of HISAT 2. It is used to extract codis data for DNA      #
# fingerprinting                                                              #
#                                                                             #
...
CODIS_loci = ["CSF1PO",  "FGA",    "TH01",   "TPOX",    "VWA", 
...
def download_codis(base_dname,
    ...
    #   <td width="35%"><font size="2">[TTTC]<sub>4</sub>TTTT TT<span style=
    # "mso-spacerun: yes"> </span>[CTTT]<sub>14</sub>[CTGT]<sub>3</sub>[CTTT]
    # <sub>14 </sub>[CTTC]<sub>4</sub>[CTTT]<sub>3</sub>CTCC[TTCC]<sub>4</sub></font> </td>
    ...
    for locus_name in CODIS_loci:
        ...
        for allele_id, repeat_st in alleles:
            print("%s\t%s\t%s" % (locus_name, allele_id, repeat_st), 
